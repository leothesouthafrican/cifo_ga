...
class Individual:
    ...
    def __getitem__(self, snake_position):
        return self.representation[snake_position]

    def __setitem__(self, snake_position, value):
        self.representation[snake_position] = value
