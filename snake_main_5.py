...
population_1 = Population(size = 50,gens=500, runs = 10, environment_used = environment_1, optim = "max", output_file_name = "test_13", individual_moves=500)
population_2 = Population(size = 50,gens=500, runs = 10, environment_used = environment_1, optim = "max", output_file_name = "test_14", individual_moves=500)
population_3 = Population(size = 50,gens=500, runs = 10, environment_used = environment_1, optim = "max", output_file_name = "test_15", individual_moves=500)
